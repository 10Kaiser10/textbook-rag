...
class RAG_Piepline:
    def __init__(self, retriever, groq_api_key, langchain_api_key, langchain_project="textbook-rag", custom_template=None, enable_tracing='true', langchain_endpoint="https://api.smith.langchain.com"):
        ...
        llm = ChatGroq(model='llama-3.1-8b-instant', temperature=0.5, max_retries=2, api_key=groq_api_key)
